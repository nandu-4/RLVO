...
def parse_args():
    ...
    arguments related to the test configuration, checkpoint file, output options,
...
def main():
    ...
    sets up the work directory, applies test-time augmentation if specified,
    builds the runner, adds the `DumpResults` metric if needed, and starts testing.
    """
    args = parse_args()
